import { a as useState, u as useAsyncStoryblok } from "./useAsyncStoryblok-Drmi3ClY.js";
...
import { ssrRenderAttr, ssrInterpolate, ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrRenderStyle } from "vue/server-renderer";
import "hookable";
import "ofetch";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1${_scopeId}>Visuel designstuderende med kode som materiale</h1><h4${_scopeId}>Søger praktik i perioden 20. oktober 2025 – 6. marts 2026</h4>`);
          } else {
            return [
              createVNode("h1", null, "Visuel designstuderende med kode som materiale"),
              createVNode("h4", null, "Søger praktik i perioden 20. oktober 2025 – 6. marts 2026")
            ];
          }
        }),
        _: 1
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    let __temp, __restore;
    [__temp, __restore] = withAsyncContext(() => useAsyncStoryblok("home", { version: "draft" })), __temp = await __temp, __restore(), __temp;
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=index-Dagkb3ov.js.map
