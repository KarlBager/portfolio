import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, defineComponent, createVNode, Fragment, reactive, computed, nextTick, onMounted, onBeforeUnmount, Teleport, Transition, provide, createElementBlock, shallowReactive, h as h$1, Suspense, useSSRContext, unref, isVNode, withModifiers, resolveComponent, useAttrs, mergeProps, onUnmounted, withCtx, createApp, effectScope, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, createTextVNode, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, openBlock, createBlock } from 'vue';
import { $ as $fetch, h as createError$1, l as defu, m as hasProtocol, n as joinURL, p as parseURL, o as parseQuery, q as encodeParam, r as createHooks, w as withQuery, t as isScriptProtocol, v as withTrailingSlash, x as withoutTrailingSlash, y as withLeadingSlash, z as sanitizeStatusCode, A as isSamePath, B as toRouteMatcher, C as createRouter$1, D as encodePath } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./_...slug_-Y6aC73qg.mjs').then((m2) => m2.default || m2)
  },
  {
    ...
    component: () => import('./AboutView-CsWJ9nvV.mjs').then((m2) => m2.default || m2)
  },
  {
    ...
    component: () => import('./index-Dagkb3ov.mjs').then((m2) => m2.default || m2)
  },
  {
    ...
    component: () => import('./KontaktView-Daksceul.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "presentation",
    path: "/presentation",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./presentation-GherqCwt.mjs').then((m2) => m2.default || m2)
  }
];
...
const LazyProjectPage = defineAsyncComponent(() => import('./ProjectPage-Da4ZIEFY.mjs').then((r) => r["default"] || r.default || r));
const LazyProjectPageFourup = defineAsyncComponent(() => import('./ProjectPageFourup-DBXdDeb8.mjs').then((r) => r["default"] || r.default || r));
const LazyProjectPageHeaderBlock = defineAsyncComponent(() => import('./ProjectPageHeaderBlock-BdiFqQpP.mjs').then((r) => r["default"] || r.default || r));
const LazyProjectPageImageGalleryContainer = defineAsyncComponent(() => import('./ProjectPageImageGalleryContainer-B8NDFQDN.mjs').then((r) => r["default"] || r.default || r));
const LazyProjectPageOneup = defineAsyncComponent(() => import('./ProjectPageOneup-K2SnBFM8.mjs').then((r) => r["default"] || r.default || r));
const LazyProjectPageParagraph = defineAsyncComponent(() => import('./ProjectPageParagraph-ay_oZQKG.mjs').then((r) => r["default"] || r.default || r));
const LazyProjectPageThreeupOld = defineAsyncComponent(() => import('./ProjectPageThreeup-old-BwxATHK8.mjs').then((r) => r["default"] || r.default || r));
const LazyProjectPageThreeup = defineAsyncComponent(() => import('./ProjectPageThreeup-BWFJ5rGC.mjs').then((r) => r["default"] || r.default || r));
const LazyProjectPageTwoup = defineAsyncComponent(() => import('./ProjectPageTwoup-O-m21xAd.mjs').then((r) => r["default"] || r.default || r));
const LazyProjectPageVideo = defineAsyncComponent(() => import('./ProjectPageVideo-CMheizIr.mjs').then((r) => r["default"] || r.default || r));
...
const Pe = () => (y || E("useStoryblokApi"), y), Ie = {
  install(i, e = {}) {
    i.directive("editable", Se), i.component("StoryblokComponent", Te), e.enableFallbackComponent && !e.customFallbackComponent && i.component(
      "FallbackComponent",
      defineAsyncComponent(() => import('./FallbackComponent-D9TGQNbC-Bkr58ody.mjs'))
    );
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DW-sShg7.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-hzpJTaVc.mjs').then((r) => r.default || r));
...
export { Pe as P, _export_sfc as _, __nuxt_component_0 as a, useRoute as b, asyncDataDefaults as c, useNuxtApp as d, entry$1 as default, createError as e, useHead as u };
