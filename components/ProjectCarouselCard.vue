...
<div class="case-card case-card-container">
    ...
    <div :style="{ backgroundImage: 'url(' + filteredProjects[0].content.ProjectPageHeaderBlock[0].headerImagePath + ')' }" class="case-card">
        ...
        <div v-if="filteredProjects[0].content.ProjectPageHeaderBlock[0].headerVideo" class="case-card-wide-video-overlay">
          <div class="video"><video class="video" autoplay muted loop>
...
<!-- 
        <div class="case-card-typo-container drop-shadow-lg">
            <h2 :style="{ color: filteredProjects[0].content.ProjectPageHeaderBlock[0].titleColor }">{{ filteredProjects[0].content.ProjectPageHeaderBlock[0].title }}</h2>
            <h4 :style="{ color: filteredProjects[0].content.ProjectPageHeaderBlock[0].titleColor }">{{ filteredProjects[0].content.ProjectPageHeaderBlock[0].subtitle }}, {{filteredProjects[0].content.ProjectPageHeaderBlock[0].year}}</h4>
        </div>
 -->

<!-- 
        <div class="case-card-year-container drop-shadow-lg">
            <h4 :style="{ color: filteredProjects[0].titleColor }">{{filteredProjects[0].year}}</h4>
        </div> -->
